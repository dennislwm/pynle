...
3. `make play ARGS='hjkl'` sends the keys and prints the screen. A batch stops
   ...
   gates are:
   - G2: more than one key near a peaceful.
   - G3: `F` at a tame or peaceful monster, or a move into a peaceful one.
   - G4: rest or search with a hostile in view, or over 10 turns.
   - G5: rest or search while Hungry, Weak or Fainting.
